        ...
        <div class="row" id="last_tweet">
          ...
          <div class="col-xs-12 col-sm-4" id="tweet_meta">
            <div class="row">
              ...
              <div class="col-sm-7">
                <a id="badge" href="https://twitter.com/um_bjm" class="tweet-link btn-lg btn-default" data-ua-action="@um_bjm timeline" data-ua-label="badge">
...
<section id="video">
  <div class="container">
    <div class="row">
      <p>
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptate deserunt dolorem quam, dolore unde ea maxime accusantium dignissimos aut consequatur nemo, molestiae aliquid! Aut commodi facere eos. Nihil, earum. Tempore.
      </p>
    </div>
  </div>
</section>
